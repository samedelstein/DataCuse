...
$env:VISION_PROVIDER="ollama" # default
$env:OLLAMA_VISION_MODEL="llava:latest" # or another local vision model
...
The task starts a few minutes after registration and repeats hourly. Use `-NoPush` if you want local commits without pushing.
